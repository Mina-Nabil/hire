                    ...
                    <ul class="nav nav-tabs flex flex-col md:flex-row flex-wrap list-none border-b-0 pl-0"
                        ...
                        <li class="nav-item" role="presentation" wire:click="setActiveTab('payrolls')">
                            <a href="#tabs-payrolls"
                                ...
                                id="tabs-payrolls-tab" data-bs-toggle="pill" data-bs-target="#tabs-payrolls"
                                role="tab" aria-controls="tabs-payrolls" aria-selected="false">
                        ...
                        <li class="nav-item" role="presentation" wire:click="setActiveTab('payments')">
                            <a href="#tabs-payments"
                                ...
                                id="tabs-payments-tab" data-bs-toggle="pill" data-bs-target="#tabs-payments"
                                role="tab" aria-controls="tabs-payments" aria-selected="false">
                                <iconify-icon class="mr-1" icon="mdi:currency-usd"></iconify-icon>
                                Payments</a>
                        </li>
                                    ...
                                    @if (count($employeeVacations) > 0)
                                        <div class="space-y-3">
                                            @foreach ($employeeVacations as $vacation)
                                                <div class="border rounded-lg p-3 hover:bg-slate-50">
                                                    <div class="flex justify-between items-center">
                                                        <h6 class="font-medium text-slate-900">{{ $vacation->name }}
                                                        </h6>
                                            ...
                                            @forelse($payrollRecords as $payrollRecord)
                                                <tr wire:key="employee-{{ $payrollRecord->id }}">
                                                    ...
                                                    <td class="table-td font-semibold">
                                                        {{ number_format($payrollRecord->net_after_deductions, 2) }}
                                                    </td>
                                                    <td class="table-td">
                                                        <div class="flex space-x-2">
                                                            <button type="button"
                                                ...
                                                <tr>
                                                    <td colspan="11" class="table-td text-center py-8">
                                                        <div class="flex flex-col items-center">
                                                            ...
                                                            <p class="text-sm text-slate-400 mt-1">This employee
                                                                doesn't
                                                                have any
                                                                payroll records</p>
                                                        </div>
            ...
            @if ($showAddCustomVacationBenefitModal)
                <x-modal wire:model="showAddCustomVacationBenefitModal">
                    ...
                    <x-slot name="footer">
                        <div class="mt-4 flex justify-end gap-3">
                            <x-secondary-button
                                wire:click="closeAddCustomVacationBenefitModal">Cancel</x-secondary-button>
                ...
                <x-modal wire:model="showAddLoanModal">
                    ...
                    <div class="space-y-6">
                        ...
                        <div class="grid grid-cols-1 gap-4">
                            <x-text-input label="Total Amount*" type="number" step="0.01"
                                wire:model="loan.amount" wire:change="updateRemainingAmount"
                                errorMessage="{{ $errors->first('loan.amount') }}" />
                    ...
                    <x-slot name="footer">
                        <div class="mt-4 flex justify-end gap-3">
                            ...
                            <x-primary-button wire:click.prevent="saveLoan" loadingFunction="saveLoan"
                                :disabled="$loanRemainingAmount != 0">
                                Save
                            </x-primary-button>
                        </div>
                    </x-slot>
                ...
                <x-modal wire:model="showAddExtraPaymentModal">
                    ...
                    <x-slot name="footer">
                        <div class="mt-4 flex justify-end gap-3">
                            ...
                            <x-primary-button wire:click.prevent="saveExtraPayment"
                                loadingFunction="saveExtraPayment">
                                Save
                            </x-primary-button>
                        </div>
                    </x-slot>
                    ...
                    <div class="flex items-center">
                        ...
                        <div class="ml-3">
                            ...
                            <p class="text-sm text-slate-500 dark:text-slate-400">
                                {{ $selectedPayrollEmployee->position }} -
                    ...
                    <div>
                        ...
                        <div class="grid  md:grid-cols-6 sm:grid-cols-1 gap-4">
                            <div class="bg-slate-50 dark:bg-slate-700 rounded-md p-3">
                                <h5 class="text-xs font-medium text-slate-500 dark:text-slate-300 mb-1">Gross Salary
                                </h5>
                                <div class="text-sm font-semibold">
                                    {{ number_format($selectedPayrollEmployee->gross_salary, 2) }}</div>
                            </div>
                            <div class="bg-slate-50 dark:bg-slate-700 rounded-md p-3">
                                <h5 class="text-xs font-medium text-slate-500 dark:text-slate-300 mb-1">Social
                                    Insurance
                                    Salary
                                </h5>
                                <div class="text-sm font-semibold">
                            ...
                            <div class="bg-slate-50 dark:bg-slate-700 rounded-md p-3">
                                <h5 class="text-xs font-medium text-slate-500 dark:text-slate-300 mb-1">Other Amount
                                </h5>
                                <div class="text-sm font-semibold">
                                    {{ number_format($selectedPayrollEmployee->other_amount, 2) }}</div>
                            </div>
                            <div class="bg-slate-50 dark:bg-slate-700 rounded-md p-3">
                                <h5 class="text-xs font-medium text-slate-500 dark:text-slate-300 mb-1">Employee
                                    Insurance
                                </h5>
                                <div class="text-sm font-semibold">
                            ...
                            <div class="bg-slate-50 dark:bg-slate-700 rounded-md p-3">
                                <h5 class="text-xs font-medium text-slate-500 dark:text-slate-300 mb-1">Employer
                                    Insurance
                                </h5>
                                <div class="text-sm font-semibold">
                            ...
                            <div class="bg-slate-50 dark:bg-slate-700 rounded-md p-3">
                                <h5 class="text-xs font-medium text-slate-500 dark:text-slate-300 mb-1">Penalty Days
                                </h5>
                                <div class="text-sm font-semibold">
                                    {{ number_format($selectedPayrollEmployee->penalties_days, 2) }}</div>
                            </div>
                            <div class="bg-slate-50 dark:bg-slate-700 rounded-md p-3">
                                <h5 class="text-xs font-medium text-slate-500 dark:text-slate-300 mb-1">Penalty Amount
                                </h5>
                                <div class="text-sm font-semibold text-danger-500">
                                    -{{ number_format($selectedPayrollEmployee->penalties_amount, 2) }}</div>
                            </div>
                            <div class="bg-slate-50 dark:bg-slate-700 rounded-md p-3">
                                <h5 class="text-xs font-medium text-slate-500 dark:text-slate-300 mb-1">Net After
                                    Penalty
                                </h5>
                                <div class="text-sm font-semibold">
                            ...
                            <div class="bg-slate-50 dark:bg-slate-700 rounded-md p-3">
                                <h5 class="text-xs font-medium text-slate-500 dark:text-slate-300 mb-1">Extra Payments
                                </h5>
                                <div class="text-sm font-semibold">
                                    {{ number_format($selectedPayrollEmployee->extra_payments, 2) }}</div>
                            </div>
                            <div class="bg-slate-50 dark:bg-slate-700 rounded-md p-3">
                                <h5 class="text-xs font-medium text-slate-500 dark:text-slate-300 mb-1">Overtime Hours
                                </h5>
                                <div class="text-sm font-semibold">
                            ...
                            <div class="bg-slate-50 dark:bg-slate-700 rounded-md p-3">
                                <h5 class="text-xs font-medium text-slate-500 dark:text-slate-300 mb-1">Adjustment
                                    Amount
                                </h5>
                                <div
                            ...
                            <div class="bg-primary-50 dark:bg-primary-900/20 rounded-md p-3 md:col-span-6">
                                <h5 class="text-xs font-medium text-primary-500 dark:text-primary-400 mb-1">Net Amount
                                </h5>
                            ...
                            <div class="overflow-x-auto">
                                <table class="min-w-full divide-y divide-slate-100 table-fixed dark:divide-slate-700">
                                    ...
                                    <tbody
                                        ...
                                        @empty
                                            <tr>
                                                <td colspan="5" class="table-td text-center py-4">No attendance
                                                    records
                                                    found</td>
                                            </tr>
                                        @endforelse
                                    ...
                                    <tbody
                                        ...
                                        @forelse($employeeBenefitPayments as $benefit)
                                            <tr>
                                                ...
                                                <td class="table-td">
                                                    {{ ucfirst($benefit->baseBenefit->type ?? 'N/A') }}
                                                </td>
                                        ...
                                        @empty
                                            <tr>
                                                <td colspan="4" class="table-td text-center py-4">No benefit
                                                    payments
                                                    found</td>
                                            </tr>
                                        @endforelse
                            ...
                            <div class="overflow-x-auto">
                                <table class="min-w-full divide-y divide-slate-100 table-fixed dark:divide-slate-700">
                                    ...
                                    <tbody
                                        ...
                                        @empty
                                            <tr>
                                                <td colspan="4" class="table-td text-center py-4">No overtime
                                                    records
                                                    found</td>
                                            </tr>
                                        @endforelse
                                ...
                                <div class="p-6 space-y-4">
                                    <div class="grid grid-cols-12 gap-4">
                                        ...
                                        <div class="col-span-12 xl:col-span-6">
                                            ...
                                            <textarea class="form-control @error('release_note') !border-danger-500 @enderror" wire:model="release_note"
                                                rows="3"></textarea>
                                            @error('release_note')
                                                <span
                                                    class="font-Inter text-sm text-danger-500">{{ $message }}</span>
                            ...
                            <div class="bg-slate-50 dark:bg-slate-700 p-4 rounded-lg">
                                ...
                                <div class="grid grid-cols-2 gap-4 text-sm">
                                    ...
                                    <div>
                                        ...
                                        <span
                                            class="ml-2 font-medium">{{ number_format($editingExtraPayment->amount, 2) }}</span>
                                    </div>
                                    <div>
