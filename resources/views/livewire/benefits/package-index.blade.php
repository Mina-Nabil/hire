<div class="space-y-5 profile-page mx-auto">
    <div class="flex justify-between items-center mb-4">
        <h2 class="text-lg font-medium">Salary Grades</h2>
        <button type="button" class="btn btn-primary" wire:click="showCreateModal">
            <i class="fas fa-plus mr-1"></i> Create Salary Grade
        </button>
    </div>
                    ...
                    <div class="flex justify-between items-center mb-2">
                        <div class="flex flex-col">
                            ...
                            <span class="text-xs text-gray-500">
                                ...
                                Included payments & allowances for the employee, paid directly to the employee or paid
                                to
                                other
                                parties like insurance or taxes.
                            </span>
                        </div>
