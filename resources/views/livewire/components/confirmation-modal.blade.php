                ...
                <div class="relative bg-white rounded-lg shadow dark:bg-slate-700">
                    ...
                    <div
                        ...
                        <button wire:click="confirm" data-bs-dismiss="modal"
                            class="btn inline-flex justify-center text-white bg-{{ $color }}-500 btn-sm ml-2">نعم
                            تأكيد</button>
                        <button wire:click="closeModal" data-bs-dismiss="modal"
                            class="btn inline-flex justify-center text-white btn-outline-dark btn-sm">الغاء</button>
                    </div>
                </div>
            </div>
        </div>
