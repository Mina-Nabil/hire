    ...
    <div>
        <div class="card">
            <div class="card-header">
                <h4 class="card-title">Apply for Vacation</h4>
        </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-5 mb-5 mt-5">
                        ...
                        <div >
                            <x-select wire:model.live="selectedBenefitId" label="Vacation Type*"
                                errorMessage="{{ $errors->first('selectedBenefitId') }}" class="w-full {{ $errors->has('selectedBenefitId') ? '!border-danger-500' : '' }}">
                                    ...
                                    <tbody
                                        ...
                                        @foreach ($days as $index => $day)
                                            <tr>
                                                ...
                                                <td class="table-td">
                                                    <input type="number" class="form-control py-2 w-20" min="1"
                                                        max="24" wire:model="days.{{ $index }}.hours"
            ...
            <div class="mb-5">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-3">
                    ...
                    <div class="border rounded p-3">
                        ...
                        <p class="font-medium">{{ ($selectedBenefit->current_balance ?? 0) - $totalHours }} hours</p>
                    </div>
                    @if ($description)
